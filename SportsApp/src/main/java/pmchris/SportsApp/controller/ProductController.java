...
public class ProductController {
    ...
    public ResponseEntity<Response> createProduct(
        ...
        return ResponseEntity.ok(productService.createProduct(categoryId,name,price,description,image ));
    }
    ...
    public ResponseEntity<Response> updateProduct(
        ...
        return ResponseEntity.ok(productService.updateProduct(productId, categoryId, name, price, description, image ));
    }
    ...
    public ResponseEntity<Response> searchForProduct(@RequestParam String searchValue) {
        return ResponseEntity.ok(productService.searchProducts(searchValue));
    }
